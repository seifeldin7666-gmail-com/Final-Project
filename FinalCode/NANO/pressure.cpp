...
#define MCLOCK_PIN 9 //A pwm pin in MEGA
...
//     const float *pressure2 = *pressure - P2;

//     float *temp2 = TEMP2/10;
//     float *pressureHG2 = *pressure2 * 750.06 / 10000; // mbar*10 -> mmHg === ((mbar/10)/1000)*750/06
