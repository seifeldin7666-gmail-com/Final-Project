 ...
 */
  ...
  switch(button){
      case BUTTON_UP_f:analogWrite(pwm_5,126);//analogWrite(pwm_5,map(BUTTON_UP_f,0,32,0,255));
...
*/
   ...
   * Try adding setpoint
   */
  matrix2[0][0] = pidX.compute( ROVMASS * accX , matrix2[0][0]);//Current force on ROV
